...
def augment_data(image_paths, labels, target_count):
    ...
    while len(augmented_image_paths) < target_count:
...
train_image_paths.extend(attack_free_train_images[:10000])
train_labels.extend(attack_free_train_labels[:10000])
train_image_paths.extend(dos_attack_train_images)
train_labels.extend(dos_attack_train_labels)
train_image_paths.extend(fuzzy_attack_train_images)
train_labels.extend(fuzzy_attack_train_labels)
train_image_paths.extend(impersonate_attack_train_images)
...
# Perform data augmentation
dos_attack_test_images, dos_attack_test_labels = augment_data(dos_attack_test_images, dos_attack_test_labels, 3000)
fuzzy_attack_test_images, fuzzy_attack_test_labels = augment_data(fuzzy_attack_test_images, fuzzy_attack_test_labels, 3000)
impersonate_attack_test_images, impersonate_attack_test_labels = augment_data(impersonate_attack_test_images, impersonate_attack_test_labels, 3000)

test_image_paths.extend(attack_free_test_images[:3000])
test_labels.extend(attack_free_test_labels[:3000])
test_image_paths.extend(dos_attack_test_images)
test_labels.extend(dos_attack_test_labels)
test_image_paths.extend(fuzzy_attack_test_images)
test_labels.extend(fuzzy_attack_test_labels)
test_image_paths.extend(impersonate_attack_test_images)
...
# Save the model
torch.save(model.state_dict(), 'model2_DeepCNN.pth')
...
# Perform data augmentation
attack_free_train_images, attack_free_train_labels = augment_No_data(attack_free_train_images, attack_free_train_labels, 10000)
dos_attack_train_images, dos_attack_train_labels = augment_data(dos_attack_train_images, dos_attack_train_labels, 10000)
fuzzy_attack_train_images, fuzzy_attack_train_labels = augment_data(fuzzy_attack_train_images, fuzzy_attack_train_labels, 10000)
impersonate_attack_train_images, impersonate_attack_train_labels = augment_data(impersonate_attack_train_images, impersonate_attack_train_labels, 10000)
...
# Perform data augmentation
attack_free_test_images, attack_free_test_labels = augment_No_data(attack_free_test_images, attack_free_test_labels, 3000)
dos_attack_test_images, dos_attack_test_labels = augment_data(dos_attack_test_images, dos_attack_test_labels, 3000)
fuzzy_attack_test_images, fuzzy_attack_test_labels = augment_data(fuzzy_attack_test_images, fuzzy_attack_test_labels, 3000)
impersonate_attack_test_images, impersonate_attack_test_labels = augment_data(impersonate_attack_test_images, impersonate_attack_test_labels, 3000)
