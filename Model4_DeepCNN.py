...
attack_free_train_images, attack_free_train_labels = augment_data(attack_free_train_images, attack_free_train_labels, 30000)
dos_attack_train_images, dos_attack_train_labels = augment_data(dos_attack_train_images, dos_attack_train_labels, 30000)
fuzzy_attack_train_images, fuzzy_attack_train_labels = augment_data(fuzzy_attack_train_images, fuzzy_attack_train_labels, 30000)
impersonate_attack_train_images, impersonate_attack_train_labels = augment_data(impersonate_attack_train_images, impersonate_attack_train_labels, 30000)
...
# Perform data augmentation
attack_free_test_images, attack_free_test_labels = augment_data(attack_free_test_images, attack_free_test_labels, 10000)
dos_attack_test_images, dos_attack_test_labels = augment_data(dos_attack_test_images, dos_attack_test_labels, 10000)
fuzzy_attack_test_images, fuzzy_attack_test_labels = augment_data(fuzzy_attack_test_images, fuzzy_attack_test_labels, 10000)
impersonate_attack_test_images, impersonate_attack_test_labels = augment_data(impersonate_attack_test_images, impersonate_attack_test_labels, 10000)
...
# Save the model
torch.save(model.state_dict(), 'model4_DeepCNN.pth')
