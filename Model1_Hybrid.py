...
attack_free_train_images, attack_free_train_labels = augment_No_data(attack_free_train_images, attack_free_train_labels, 5000)
dos_attack_train_images, dos_attack_train_labels = augment_No_data(dos_attack_train_images, dos_attack_train_labels, 5000)
fuzzy_attack_train_images, fuzzy_attack_train_labels = augment_No_data(fuzzy_attack_train_images, fuzzy_attack_train_labels, 5000)
impersonate_attack_train_images, impersonate_attack_train_labels = augment_No_data(impersonate_attack_train_images, impersonate_attack_train_labels, 5000)
...
# Perform data augmentation
attack_free_test_images, attack_free_test_labels = augment_No_data(attack_free_test_images, attack_free_test_labels, 1250)
dos_attack_test_images, dos_attack_test_labels = augment_No_data(dos_attack_test_images, dos_attack_test_labels, 1250)
fuzzy_attack_test_images, fuzzy_attack_test_labels = augment_No_data(fuzzy_attack_test_images, fuzzy_attack_test_labels, 1250)
impersonate_attack_test_images, impersonate_attack_test_labels = augment_No_data(impersonate_attack_test_images, impersonate_attack_test_labels, 1250)
...
# Save the model
torch.save(model.state_dict(), 'hybrid_model1.pth')
