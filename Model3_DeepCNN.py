...
attack_free_train_images, attack_free_train_labels = augment_No_data(attack_free_train_images, attack_free_train_labels, 20164)
dos_attack_train_images, dos_attack_train_labels = augment_data(dos_attack_train_images, dos_attack_train_labels, 20164)
fuzzy_attack_train_images, fuzzy_attack_train_labels = augment_data(fuzzy_attack_train_images, fuzzy_attack_train_labels, 20164)
impersonate_attack_train_images, impersonate_attack_train_labels = augment_data(impersonate_attack_train_images, impersonate_attack_train_labels, 20164)
...
# Perform data augmentation
attack_free_test_images, attack_free_test_labels = augment_No_data(attack_free_test_images, attack_free_test_labels, 5040)
dos_attack_test_images, dos_attack_test_labels = augment_data(dos_attack_test_images, dos_attack_test_labels, 5040)
fuzzy_attack_test_images, fuzzy_attack_test_labels = augment_data(fuzzy_attack_test_images, fuzzy_attack_test_labels, 5040)
impersonate_attack_test_images, impersonate_attack_test_labels = augment_data(impersonate_attack_test_images, impersonate_attack_test_labels, 5040)
...
# Save the model
torch.save(model.state_dict(), 'model3_DeepCNN.pth')
